...
const Services = () => {
  return (
    ...
    >
      ...
      >
        I am a fullstack engineer with 3 years of experience from companies like barclays and finfactor
      </motion.p>
      
      <motion.div className="grid grid-template-auto gap-6 my-10"
      initial={{y:-20, opacity:0}}
      whileInView={{y:0, opacity:1}}
