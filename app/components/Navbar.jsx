    ...
    <> 
      ...
      <nav className='w-full fixed px-5 lg:px-8 xl-px-[8%] py-4 flex item-center justify-between z-50'>
        ...
        <div className='flex item-center gap-4'>
          ...
          <a href="#contact" className='hidden md:flex item-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4'> Contact <Image src={assets.arrow_icon} alt='' className='w-3'/> </a>
