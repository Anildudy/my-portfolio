  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className='mb-10 mx-w-2xl font-ovo'> I am an exprienced fullstack developer with more than 3 years of experience in the field. Thorughout my carrer i had the privilage of working with 
            prestigous organization's like barclays and finfactor contributing to their success and growth.
          </p>
          ...
          >
            {infoList.map(({icon, iconDark, title, description}, 
              index) => (
                <motion.li key={index} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lighthover hover:shadow-black hover:-translate-y-1 duration-500 dark:border-white dark:hover:shadow-white dark:hover:bg-darkhover/50'
